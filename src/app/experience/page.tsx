...
export const metadata: Metadata = {
    title: 'Experience',
    description: 'An overview of Aakash Sanghvi\'s product leadership, UX, and full-stack delivery experience.',
    alternates: {
                ...
                <section className="px-6 py-20 lg:px-12 lg:py-28">
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-14 max-w-2xl space-y-4">
                            ...
                            <p className="text-lg font-light" style={{ color: 'var(--color-text-muted)' }}>
                                A concise view of the work so far. LinkedIn provides the complete chronology, and the detailed case studies show the work behind each claim.
                            </p>
                        </div>
                ...
                <section className="border-y px-6 py-20 lg:px-12 lg:py-24" style={{ borderColor: 'var(--color-border)' }}>
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-12 max-w-3xl space-y-4">
                            ...
                            <p className="text-lg font-light" style={{ color: 'var(--color-text-muted)' }}>
                                Role, setting, and timing are separated to distinguish client work, independent products, research, and embedded delivery.
                            </p>
                        </div>
                ...
                <section className="px-6 py-24 text-center lg:px-12 lg:py-32">
                    <div className="mx-auto max-w-3xl space-y-7">
                        ...
                        <div className="flex flex-col justify-center gap-3 pt-2 sm:flex-row">
                            <a
                                href="mailto:connect@aakashsanghvi.com?subject=Conversation%20with%20Aakash%20Sanghvi"
