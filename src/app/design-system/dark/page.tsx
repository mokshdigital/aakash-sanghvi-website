...
export default function DarkDesignSystem() {
    return (
        <div data-theme="dark" className="min-h-screen relative" style={{ backgroundColor: 'var(--color-bg)', color: 'var(--color-text)' }}>
            {/* Noise Overlay */}
                ...
                <div className="max-w-4xl mx-auto space-y-20 stagger-children">
                    ...
                    <header className="space-y-6">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-8xl font-black tracking-tighter leading-[0.95]">
                            Senior <span className="gradient-text">Jazz</span>
                        </h1>
                        <p className="text-xl md:text-2xl leading-relaxed font-light max-w-2xl" style={{ color: 'var(--color-text-muted)' }}>
                            Subtle gradients. Smooth animations. Refined typography.
                            Impresses without being loud.
                        </p>
                    </header>
                    ...
                    <section className="space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            {/* Card with Glow */}
                            <div className="p-8 rounded-xl space-y-4 glow transition-all duration-300 hover:-translate-y-1"
                                style={{ backgroundColor: 'var(--color-bg-elevated)', border: '1px solid var(--color-border)' }}>
                                <h3 className="text-xl font-bold">Glow Effect</h3>
                                <p className="font-light" style={{ color: 'var(--color-text-muted)' }}>
                                    Hover to see the glow intensify. Subtle depth that feels premium.
                                </p>
                            </div>
                        </div>
                    </section>
